...
print('Message Color = ({}, {}, {})'.format(int_text_red, int_text_blue, int_text_green))
...
print('Background Color = ({}, {}, {})'.format(int_bg_red, int_bg_blue, int_bg_green))
